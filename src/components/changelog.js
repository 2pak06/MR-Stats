...
const CURRENT_VERSION_CHANGES = [
  {
    title: "🆕 Нове",
    changes: [
      "Повністю перероблено календар.",
      "Планування рецептів по днях.",
      "Планування тренувань по днях.",
      "Позначення виконання прийомів їжі.",
      "Позначення виконання тренувань.",
      "Перегляд усіх запланованих подій дня."
    ]
  },
  {
    title: "✨ Покращено",
    changes: [
      "Оновлено верхню панель навігації.",
      "Покращено інтерфейс календаря.",
      "Додано індикатор стану тренувань (💪 / 💪✓)."
    ]
  },
  {
    title: "🐞 Виправлено",
    changes: [
      "Виправлено відображення іконки застосунку."
    ]
  }
];
...
function renderAllVersionChanges() {
  return ALL_VERSION_CHANGES.map((release) => `
    <section class="changelogCategory changelogVersion">
      ...
      ${release.sections
        ? release.sections.map(renderChangeCategory).join("")
